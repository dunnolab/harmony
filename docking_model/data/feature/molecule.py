...
from docking_model.data.constants import allowable_features, bonds
from docking_model.data.feature.helpers import (
    safe_index,
    get_fragment_index,
    get_transformation_mask,
)
from docking_model.data.conformers.molecule import (
    generate_conformer,
    get_torsion_angles,
    ...
    for idx, atom in enumerate(mol.GetAtoms()):
        ...
        atom_features_list.append(
            [
                ...
                # allowable_features["possible_chirality_list"].index(
                #     "CHI_OTHER" if str(atom.GetChiralTag()) not in allowable_features["possible_chirality_list"] \
                #     else str(atom.GetChiralTag())
                # ),
                safe_index(
